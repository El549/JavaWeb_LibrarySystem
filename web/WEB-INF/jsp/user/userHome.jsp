...
<div class="mySidebar" id="mySidebar">
    ...
    <br>
    <div class="bar-item">
        <a class="col-auto" href="user/bookListU">借阅图书</a>
        <a class="col-auto">&gt;</a>
    </div>
    <div class="bar-item">
        <a class="col-auto" href="user/myApplyList?userId=${user.userId}">申请记录</a>
        <a class="col-auto">&gt;</a>
    </div>
    <div class="bar-item">
        <a class="col-auto" href="user/borrowingHistoryListByUserId?userId=${user.userId}">借阅记录</a>
        <a class="col-auto">&gt;</a>
    </div>
    <div class="bar-item">
        <a class="col-auto" href="user/outstandingBookList">未还图书</a>
        <a class="col-auto">&gt;</a>
    </div>
    <div class="bar-item">
        <a class="col-auto" href="user/modUserInfo">我的信息</a>
        <a class="col-auto">&gt;</a>
    </div>
...
<div class="container">
    <div class="container_1" id="container_1">
        ...
        <div class="searchBoxesContainer" style="width: 93%">
            <div class="searchBoxes row">
                <div class="searchBox1 searchBox col">
                    <p class="searchMethod sm1">图书名搜索</p>
                    <div class="searchInputBox">
                        <form action="user/bookListByConditionsU" method="post">
                            <input name="bookName" type="text" placeholder="" style="width: 80%">
                    ...
                    <a class="searchIntro" href="#" onclick="none;">查询图书 ></a>
                    <a class="searchIntro" href="#" onclick="none;">借阅图书 >></a>
                </div>
