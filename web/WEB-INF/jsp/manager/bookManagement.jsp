...
<div class="container" style="width: 100%">
    ...
    <div class="searchBookOut">
        <div class="searchBook0">
            ...
            <div class="addBook">
                <button href="" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">添加图书</button>
            </div>
        </div>
        <div class="searchResultBox" style="width: 100%;text-align: center;">
            <div class="searchResults" style="width: 60%;margin: auto;">
                ...
                %>
                <%if (p > 1) {%>
                <a href="manager/bookList?page=<%=p-1%>">上一页</a>
                <%}%>
                <%if (p < pageCount) {%>
                <a href="manager/bookList?page=<%=p+1%>">下一页</a>
                <%}%>
            </div>
        </div>
    ...
    <!--        </div>-->
    <div class="footer" style="top: 220%">
